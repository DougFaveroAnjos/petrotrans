...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="imagens/PETROTRANS%20-%20favicon.png" type="image/x-icon"/>
    <!-- Author Meta -->
    <meta name="Roger Petrochinski" content="CodePixar">
    <!-- Meta Description -->
    <meta name="A melhor transportadora de máquinas em Curitiba" content="">
    <!-- Meta Keyword -->
    <meta name="keywords" content="">
    <!-- meta character set -->
    <meta charset="UTF-8">
    <!-- Site Title -->
    <title>PETROTRANS - Transportes & Logística</title>
    ...
    <link rel="stylesheet" href="css/petrotrans.css">
</head>
<body>
<!-- Start Header Area -->
    ...
    <div class="container">
        <div class="header-wrap">
            <div class="header-top d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html"><img class="logoPetro" src="imagens/PETROTRANS_logo.png" alt="logo Petrotrans"></a>
                </div>
                <div class="main-menubar d-flex align-items-center">
                    <nav class="hide">
                        <a href="index.html">Inicio</a>
                        <!--
                        <a href="generic.html">A Empresa</a>
...
<!-- Start Banner Area -->
<section class="banner-area relative" style="position: relative; z-index: 1;">
    <div class="overlay overlay-bg"></div>
    <div class="container">
        <div class="row fullscreen align-items-center justify-content-center">
            <video autoplay loop muted class="novoVideo">
                <source src="video/PETROTRANS%20-%20INSTITUCIONAL.mp4" type="video/mp4">
            </video>
            <!-- style="position: relative; z-index: 1;" -->
            <div class="col-lg-12" >
                <div class="banner-content">
                    <center class="titulo">
                        <h2 class="novoH2">Bem-Vindo à </h2><h1 class="novoH1" style="margin-top: 5px;"><br>PETROTRANS</h1>
                        <p style="margin-top: -30px; color: rgb(0,255,0);">Transportes & Logística</p>
                    </center>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-lg-6 col-md-9 relative">
                ...
                <h4 class="servicosCliente">Acesso ao cliente</h4>
                <button class="servicoBotao" onclick="location.href='paginas/login.html'">Rastrear carga</button>
                <button class="servicoBotao" style="margin-top: 45%;" onclick="location.href='paginas/manutencao.html'">Fazer orçamento rápido</button>

                <div class="active-exprience-carousel">
                    <div class="item" id="servFech">
                        <img src="imagens/PETROTRANS_GALPAO.png">
                        <h3>Carga Fechada</h3>
                        <p>Operação dedicada para a sua carga que ocupa a totalidade da capacidade do veículo (lotação), independente do tipo de carroceria, onde a mercadoria é coletada na origem e segue diretamente para seu destino.</p>
                    </div>
                    <div class="item" id="servFrac">
                        <img src="imagens/CARGA%20FRACIONADA.png">
                        <h3>Carga Fracionada</h3>
                        <p>Carga Fracionada é aquela que não alcança a lotação total do veículo, e contando com um sistema moderno de logística a PETROTRANS oferece o serviço de carga fracionada com excelência, podendo assim atender empresas de diversos ramos de produção.</p>
                    </div>
                    <div class="item" id="servExpr">
                        <img src="imagens/PETROTRANS%20EXPRESS.png">
                        <h3>Express</h3>
                        <p>Entrega de documentos e pequenas mercadorias de forma ágil, rápida e eficiente. Contamos com vários motoboys à disposição, além de contar com o melhor preço nas cidades e bairros onde exercemos as atividades.</p>
                    </div>
                </div>

                <div class="carousel-trigger" style="margin-right: 75px;">
...
<section class="banner-area relative" style="margin-left: 3%; margin-bottom: 10%; margin-right: 3%">
    <center>
        <div class="video-content" style="margin-top: 5%; margin-bottom: 5%;">
            <h2 class="text-green-box" style="font-size: 30px; text-shadow:none;">Um Pouco de Nosso Trabalho</h3>
                <p class="text-green-box"></p>
        </div>

        <!-- SnapWidget -->
        <iframe src="https://snapwidget.com/embed/936046" class="snapwidget-widget" allowtransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden;  width:1100px; height:750px"></iframe>
    </center>
</section>
<!-- Start Projects Area -->
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="single-service d-flex flex-column align-items-center">
                    <div class="icon">
                        <img class="icon" src="imagens/america%20do%20sul%20petrotrans.png">
                    </div>
                    <div class="desc mt-30">
                        <h4 class="mb-10">Atuação</h4>
                        <p>A Petrotrans atua em todo o território nacional, exceto algumas localidades da Amazônia. Nossa empresa também faz transporte internacional de cargas em alguns países da América do Sul.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="single-service d-flex flex-column align-items-center">
                    <div class="icon">
                        <img class="icon" src="imagens/cross%20docking%20petrotrans%20icon.png">
                    </div>
                    <div class="desc mt-30">
                        <h4 class="mb-10">Just in Time !</h4>
                        <p>Nossa empresa conta com um serviço ágil e rápido reconhecido por nossos clientes. Isso porque temos uma plataforma desenvolvida que consegue posicionar o mais rápido possível nossos motoristas para coleta. Para nós, o tempo é algo precioso!</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="single-service d-flex flex-column align-items-center">
                    <div class="icon">
                        <img class="icon" src="imagens/CAMINHAO%20PETROTRANS.png">
                    </div>
                    <div class="desc mt-30">
                        <h4 class="mb-10">Custo benefício</h4>
                        <p>A Petrotrans trás confiança e segurança para sua carga, conta com uma equipe super experiênte que sabe como lidar com o mercado de transporte rodoviário brasileiro. É essa credibilidade que temos no mercado, e o melhor de tudo isso é seu preço super acessível.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="single-service d-flex flex-column align-items-center">
                    <div class="icon">
                        <img class="icon" src="imagens/tecnologia%20icon.png">
                    </div>
                    <div class="desc mt-30">
                        <h4 class="mb-10">Tecnologia</h4>
                        <p>Com um investimento significativo, em 2018 nossa empresa está se preparando para inovar no mercado de transporte brasileiro. Hoje, muito de nossos clientes já contam com plataformas vinculados aos seus sistemas, e pretendemos expandir ainda mais esse vinculo.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-5">
                <div class="video-wrap" style="background: url(imagens/PLANO%20DE%20FUNDO%20APRESENTA%C3%87%C3%83O%20PETROTRANS.png);">
                    <div class="overlay overlay-bg"></div>
                    <a href="video/PETROTRANS%20-%20INSTITUCIONAL.mp4" class="play-btn"><img id="playVideo" src="img/play-btn.png" alt="play video"></a>
                </div>
            </div>
            <div class="col-lg-6 col-md-7">
                <div class="video-content">
                    <h3 class="text-green-box">Nosso video institucional</h3>
                    <p class="text-green-box">Veja nosso vídeo ao lado e conheça uma pequena parte de nosso trabalho em toda Ameríca do Sul.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-5">
                <div class="contact-address">
                    <div class="single-address d-flex">
                        ...
                        <div class="desc">
                            <h5>Endereço</h5>
                            <p>Av. da Integração, 1028<br> Bairro Alto, Curitiba - Paraná - Brasil.</p>
                        </div>
                    </div>
                    <div class="single-address mt-30 d-flex">
                        ...
                        <div class="desc">
                            <h5>Email</h5>
                            <a href="comercial@petrotrans.com.br">comercial@petrotrans.com.br</a> <br>
                        </div>
                    </div>
                    <div class="single-address mt-30 d-flex">
                        <div class="icon">
                        ...
                        <div class="desc">
                            <h5>Telefone</h5>
                            <a href="tel:413367-9436"> (41) 3308-0597</a> <br>
                            <a href="tel:413077-7401"> (41) 3308-9803</a> <br>
                            <a href="tel:9.9649-4624">(41) 9.9649-4624</a> <br>
                            <a href="tel:9.9649-5078">(41) 9.9649-5078 (Alternativo)</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 ml-auto col-md-7">
                <form id="myForm" action="mail.php" method="post" class="contact-form text-right">
                    <input type="text" name="fname" placeholder="Digite seu nome" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Digite seu nome'" class="common-input mt-10" required>
                    <input type="email" name="email" placeholder="Digite seu email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" class="common-input mt-10" required>
                    <input type="text" name="wpp" placeholder="Digite seu celular com DDD" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Digite seu celular com DDD'" class="common-input mt-10" required>
                    <textarea class="common-textarea mt-10" name="message" placeholder="Mensagem" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required></textarea>
                    <button class="primary-btn white-bg d-inline-flex align-items-center mt-10 ml-auto"><span class="mr-10">Enviar mensagem</span><span class="lnr lnr-arrow-right"></span></button> <br>
...
<footer class="section-gap">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6 class="text-white text-uppercase mb-20">VAMOS CRIAR UM VINCULO ?</h6>
                    <p class="mb-0 text-white">Coloque seu email e receba descontos nos fretes de sua empresa.</p>
                    <div id="mc_embed_signup">
                        <form target="_blank" novalidate action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&id=92a4423d01" method="get" class="subscription d-flex justify-content-between">
                            <input type="email" name="EMAIL" placeholder="Seu endereço de email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required>
                            <div style="position: absolute; left: -5000px;">
                                <input type="text" name="b_36c4fd991d266f23781ded980_aefe40901a" tabindex="-1" value="">
                            </div>
                            <button class="primary-btn white-bg d-inline-flex align-items-center"><span class="mr-10" style="width: 200%;">Participar</span><span class="lnr lnr-arrow-right"></span></button>
                            <div class="info"></div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-footer-widget">
                    <h6 class="text-white text-uppercase mb-20">Instafeed @PETROTRANS</h6>
        ...
        <div class="footer-bottom d-flex justify-content-between align-items-center flex-wrap">
            <p class="footer-text m-0">Copyright &copy; 2021   |   Todos os direitos reservados   <br> Petrotrans - Para todo o território nacional!
            <div class="footer-social d-flex align-items-center">
                <a href="https://www.facebook.com/petrotransportes"><i class="fa fa-facebook"></i></a>
            </div>
        </div>
    </div>
</footer>
