                ...
                <form method="get">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>CTe</label>
                                <input type="number" name="cte" id="cte" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>MDFe</label>
                                <input type="number" name="mdfe" id="mdfe" class="form-control">
                            </div>
                        </div>
                        ...
                        <?php if($fiscais):
                            ...
                            foreach ($fiscais as $fiscal): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= $router->route('Motoristas.visualizar', ['token' => $fiscal->transportes()->token]) ?>">
