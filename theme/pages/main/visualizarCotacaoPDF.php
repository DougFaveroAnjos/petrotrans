...
<table style="margin-bottom: 32px">
    ...
    <tr>
        ...
        <td>
            <b style="font-weight: bolder; font-size: 24px">Cotação</b>
            <p style="font-weight: bolder; font-size: 16px; margin: 0; padding: 0">
                Nº <?= $cotacao->id ?>
            </p>
            <p style="margin: 0; padding: 0"> Emissão: <?= date('d/m/Y'); ?>
            </p>
            <p style="margin: 0; padding: 0"> Valor: R$<?= $cotacao->valor_cotacao ?>
            </p>
...
<b style="color: red; margin-bottom: 16px">ATENÇÃO: Solicitar sempre banco santander e avisar sobre TED que é realizada até as 17 Hrs caso seja outro banco.</b>
...
<img style="width: 140px" src="theme/images/chubb.png" alt="chubb"> <br>
<b>Transporte assegurado pela CHUBB Seguros – Uma das 30 maiores seguradoras do mundo. </b>
