    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="title">Editar Motorista</h5>
            </div>
            <div class="card-body">
                <form enctype="multipart/form-data" action="<?= $router->route('Motoristas.edit', ['id' => $motorista->id]) ?>" method="post" data-action="<?= $router->route('Motoristas.edit', ['id' => $motorista->id]) ?>" onsubmit="alert('Motorista Editado!')">
